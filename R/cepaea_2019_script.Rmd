...
pp_check(mod,resp="scalefood")
pp_check(mod,resp="Nematodeliveall")
pp_check(mod,resp="Trematodekidney")


newdata <- subset(data, is_active == TRUE)
ppc_dens_overlay(
  yrep = (predict(mod, resp="scalemvt",newdata = newdata, summary = FALSE)[1:100, ]),
  y = newdata$scale_mvt
)
```
...
# Part 3 - figures, tables and other outputs
