...
Table 1 display the fixed effect coefficients values, and the random effects/ residual SDs. We do some cleaning/ordering so that the output can be directly copied into the markdown file of the manuscript
