...
Let $N_{o,m,s,i}$ and $T_{o,m,s,i}$ be the numbers of live nematodes and *Brachylaima* trematodes found in snail $i$ which was tested during session $s$, and $F_{o,m,s,i,t}$ and $M_{o,m,s,i,t}$ be the quantity of food ingested by snail $i$ (centered and scaled to 1SD), and its movement activity during trial $t$ (also centered and scaled to 1SD), respectively. We then have:
